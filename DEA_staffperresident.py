...
df = df[(df["staff_per_resident"] > 0) & (df["acuity_index"] > 0)].copy()
...
input_cols = ["staff_per_resident", "acuity_index"]
...
output_path = "DEA_staffperresident.xlsx"
...
print("DEA staff per resident model completed.")
print(summary)
