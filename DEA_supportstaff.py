...
df = df[(df["support_staff"] > 0) & (df["acuity_index"] > 0)].copy()
...
input_cols = ["support_staff", "acuity_index"]
...
output_path = "DEA_supportstaff.xlsx"
...
print("DEA support staff model completed.")
print(summary)
